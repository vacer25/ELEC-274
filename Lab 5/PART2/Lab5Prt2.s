# LB5PRT2.S [170309]
# QECE ELEC274 Lab exercise 5, part 2
###############################################################################
# Code to demonstrate using leds and 8segment display for output.
# Requirement:
# Write a program that reads characters from the JTAG port one at a time,
# and displays the numeric data represented by the character on the LED port
# and the 8segment display. In part 1, if you typed a '5', you would see
# 00 0011 0101 on the LEDs - the bit pattern for character '5'. In this part,
# you should see 00 0000 0101 on the LEDs - the bit pattern for the numeric
# value 5.  You should also see a 5 in the 8 segment display. You should
# have an idea in advance what patterns to expect.
#
# Author:
...
NotValidLetter:	
	movui	r4, '0'
	movui	r5, '9'
    bltu	r2, r4, SkipDisplay
    bgtu	r2, r5, SkipDisplay
	
	# Convert ASCII number to decimal number
	subi	r2, r2, '0'
	
	# Show number on 8 segment display and LEDs
Display:
	call	One8Seg
	call 	UpdLEDs
...
#==============================================================================
# Static data.
Prompt:	.asciz	"Type character - binary value displayed on LEDs and 8SEG"
CRLF:	.byte	CR, LF, NUL
#==============================================================================
